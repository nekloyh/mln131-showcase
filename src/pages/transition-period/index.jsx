...
const TransitionPeriodPage = () => {
  return (
    <div className="min-h-screen w-full bg-bone pt-24 pb-16 px-4 md:px-10 text-graphite font-body">
      <div className="max-w-6xl mx-auto">
        
        {/* HEADER */}
        <div className="text-center mb-16">
          <span className="text-crimson font-bold tracking-widest uppercase text-sm">Phần III, IV, V</span>
          <h1 className="font-display text-4xl md:text-5xl font-bold text-ink mt-2">
            Đảng lãnh đạo & Quan hệ với Nhân dân
          </h1>
        </div>
        ...
        <section className="mb-20">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1 relative">
               ...
               <div className="bg-white p-8 rounded-3xl shadow-lg relative rotate-1 border border-ink/5">
            ...
            <div className="order-1 md:order-2 space-y-6">
               ...
               <div className="bg-white rounded-xl p-6 border-l-4 border-crimson shadow-sm">
                 <h4 className="font-bold text-ink mb-3 uppercase text-sm tracking-wide">Phương thức lãnh đạo</h4>
                 <div className="grid grid-cols-2 gap-4">
                    <div className="bg-bone p-3 rounded-lg text-sm font-medium">1. Bằng Cương lĩnh, chiến lược</div>
                    <div className="bg-bone p-3 rounded-lg text-sm font-medium">2. Qua công tác cán bộ</div>
                    <div className="bg-bone p-3 rounded-lg text-sm font-medium">3. Công tác kiểm tra, giám sát</div>
                    <div className="bg-bone p-3 rounded-lg text-sm font-medium">4. Nêu gương & Thuyết phục</div>
                 </div>
               </div>
            </div>
          </div>
        ...
        <section className="mb-20">
           ...
           <div className="grid md:grid-cols-3 gap-6">
              <motion.div whileHover={{ y: -5 }} className="bg-white p-6 rounded-2xl shadow-sm border border-ink/5">
                 <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center text-blue-600 mb-4">
                    <Users size={24} />
                 </div>
                 <h3 className="font-display text-xl font-bold mb-3">Chủ thể quyền lực</h3>
              ...
              <motion.div whileHover={{ y: -5 }} className="bg-white p-6 rounded-2xl shadow-sm border border-ink/5">
                 ...
                 <h3 className="font-display text-xl font-bold mb-3">Cơ chế Bầu cử</h3>
                 <p className="text-sm text-graphite/70 mb-4">
              ...
              <motion.div whileHover={{ y: -5 }} className="bg-white p-6 rounded-2xl shadow-sm border border-ink/5">
                 ...
                 <h3 className="font-display text-xl font-bold mb-3">Giám sát & Phản biện</h3>
                 <p className="text-sm text-graphite/70 mb-4">
        ...
        {/* PART 3: CONCLUSION */}
        <section className="bg-ink text-bone rounded-3xl p-8 md:p-12 text-center relative overflow-hidden">
