...
const AiUsagePage = () => {
  return (
    <div className="min-h-screen bg-bone pt-24 pb-16 px-4 md:px-10 ai-usage-shell">
      ...
      >
        <div className="absolute inset-0 opacity-40 bg-[radial-gradient(circle_at_15%_25%,rgba(219,58,52,0.08),transparent_35%),radial-gradient(circle_at_85%_5%,rgba(91,117,83,0.08),transparent_30%)]"></div>
        <div className="relative z-10 space-y-6 max-w-4xl">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <a href="/ai-chatbot" className="px-5 py-3 bg-ember text-bone rounded-lg font-semibold shadow-[0_10px_30px_rgba(219,58,52,0.25)]">
